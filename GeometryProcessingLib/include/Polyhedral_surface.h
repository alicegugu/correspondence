...
namespace Monge
{
	...
	typedef Data_Kernel::Vector_3 Normal;
	typedef Data_Kernel::Point_2 PlanePoint;
	...
	//external std::map; a refined facet with a normal vector instead of
	...
	class Polyhedral_surface:public Polyhedron 
	{
	public:
		Polyhedral_surface() {}
	...
	typedef Polyhedral_surface::Halfedge_handle Halfedge_handle;
	typedef Polyhedral_surface::Vertex_handle Vertex_handle;
	typedef Polyhedral_surface::Face_handle Face_handle;
	typedef Polyhedral_surface::Point_3 Point_3;
	typedef Polyhedral_surface::Vertex Vertex;
	typedef Polyhedral_surface::Vertex_iterator Vertex_iterator;
}
