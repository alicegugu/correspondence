...
namespace Another
{
	...
	template < class TPoly , class VertexPropertyMap> class T_Polyhedral_surface_rings
	{
	protected:
		//Polyhedron
	...
	public:
		...
		//collect 1 rings and with each returned vertex, restore the length of the edge
		//To do 
// 		static void
// 			collect_1_rings_edge_len(Vertex* v,
// 			unsigned int min_nb,
// 			std::vector < Vertex * >& all,
// 			VertexPropertyMap& vpm, VertexPropertyMapEdgeLen& vpmel);
	};

	////IMPLEMENTATION/////////////////////////////////////////////////////////////////////

	template < class TPoly , class VertexPropertyMap>
	void T_Polyhedral_surface_rings <TPoly, VertexPropertyMap>::
