...
public:
	...
	Halfedge_handle& edge(){return m_edge;};
	...
	void initialize(Halfedge_handle edge, 
					Surface_point* point = NULL, 
...
protected:
	...
	Halfedge_handle m_edge;				//edge that the interval belongs to
...
public:
	...
	void initialize(Halfedge_handle e)
	{
		m_edge = e;
		m_first = NULL;
	};
	...
	void find_closest_point(Surface_point* point, 
							double& offset, 
							double& distance, 
...
private:
	...
	Halfedge_handle m_edge;				//edge that owns this list
};

class SurfacePointWithIndex : public Surface_point
{
public:
	unsigned index(){return m_index;};

	void initialize(Surface_point& p, unsigned index)
	{
		Surface_point::initialize(p);
		m_index = index;
	} 
...
public:
	...
	void initialize(std::vector<Surface_point>& sources)	//we initialize the sources by copie
	{
		resize(sources.size());
...
inline void Interval::initialize(Halfedge_handle edge, 
